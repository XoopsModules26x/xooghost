...
<head>
    ...
    <!-- Module style sheet -->
    <link rel="stylesheet" type="text/css" media="screen,print" href="<{xoImgUrl 'modules/xooghost/assets/css/module.css'}>">
...
<div class="container">
    ...
    <{include file='module:xooghost/xooghost_page.tpl'}>
</div>
</body>
</html>
